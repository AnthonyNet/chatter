...
export const Auth = (props) => {
  ...
  return (
    <section className="w-screen h-screen auth flex justify-center items-center">
      <div className="flex justify-around items-center w-[800px] h-[430px] border-b-4 powerShell text-2xl relative">
      <p>C:\  </p>
      ...
      <p className="absolute top-full right-0 text-green-700">€nty</p>
      </div>
    </section>
  );
};
